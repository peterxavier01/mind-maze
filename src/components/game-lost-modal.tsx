    ...
    >
      <div className="flex flex-col items-center text-center space-y-6 p-6">
        ...
        <div className="relative">
          <div className="w-20 h-20 bg-red-100 dark:bg-red-500/20 rounded-full flex items-center justify-center border-2 border-red-300 dark:border-red-500/40 backdrop-blur-sm">
            <XCircle className="w-10 h-10 text-red-600 dark:text-red-400" />
          </div>
          <Clock className="w-6 h-6 text-slate-600 dark:text-slate-400 absolute -bottom-1 -right-1 bg-white dark:bg-slate-800 rounded-full p-1" />
        </div>

        {/* Title */}
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-red-600 dark:text-red-400 mb-2">
            Time's Up!
          </h2>
        ...
        <div className="w-full max-w-sm">
          <div className="grid grid-cols-2 gap-4 p-4 bg-slate-100 dark:bg-slate-800/40 backdrop-blur-sm border border-slate-300/50 dark:border-slate-600/30 rounded-lg">
            <div className="text-center">
              <p className="text-slate-600 dark:text-slate-400 text-xs uppercase tracking-wider mb-1">
                Level
              </p>
        ...
        <div className="bg-slate-100/70 dark:bg-slate-800/30 backdrop-blur-sm border border-slate-300/40 dark:border-slate-600/20 rounded-lg p-4 max-w-sm">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full max-w-sm">
          ...
          <Button
            ...
            variant="outline"
            className="flex-1 border-slate-300/60 dark:border-slate-600/40 bg-slate-200/50 dark:bg-slate-700/50 hover:bg-slate-300/70 dark:hover:bg-slate-600/50 text-slate-800 dark:text-slate-200 backdrop-blur-sm"
          >
